...
const file_messages_proto_rawDesc = "" +
	"\n" +
	"\x0emessages.proto\x12\rbinibftprotos\"\xb4\x05\n" +
	"\aMessage\x12<\n" +
	"\vpre_prepare\x18\x01 \x01(\v2\x19.binibftprotos.PrePrepareH\x00R\n" +
	"prePrepare\x122\n" +
	"\aprepare\x18\x02 \x01(\v2\x16.binibftprotos.PrepareH\x00R\aprepare\x12/\n" +
	"\x06commit\x18\x03 \x01(\v2\x15.binibftprotos.CommitH\x00R\x06commit\x12<\n" +
	"\vview_change\x18\x04 \x01(\v2\x19.binibftprotos.ViewChangeH\x00R\n" +
	"viewChange\x12<\n" +
	"\tview_data\x18\x05 \x01(\v2\x1d.binibftprotos.SignedViewDataH\x00R\bviewData\x123\n" +
	"\bnew_view\x18\x06 \x01(\v2\x16.binibftprotos.NewViewH\x00R\anewView\x129\n" +
	"\n" +
	"heart_beat\x18\a \x01(\v2\x18.binibftprotos.HeartBeatH\x00R\theartBeat\x12R\n" +
	"\x13heart_beat_response\x18\b \x01(\v2 .binibftprotos.HeartBeatResponseH\x00R\x11heartBeatResponse\x12[\n" +
	"\x16state_transfer_request\x18\t \x01(\v2#.binibftprotos.StateTransferRequestH\x00R\x14stateTransferRequest\x12^\n" +
	"\x17state_transfer_response\x18\n" +
	" \x01(\v2$.binibftprotos.StateTransferResponseH\x00R\x15stateTransferResponseB\t\n" +
	"\acontent\"\xb7\x01\n" +
	"\n" +
	"PrePrepare\x12\x12\n" +
	"\x04view\x18\x01 \x01(\x04R\x04view\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x04R\x03seq\x123\n" +
	"\bproposal\x18\x03 \x01(\v2\x17.binibftprotos.ProposalR\bproposal\x12N\n" +
	"\x16prev_commit_signatures\x18\x04 \x03(\v2\x18.binibftprotos.SignatureR\x14prevCommitSignatures\"_\n" +
	"\aPrepare\x12\x12\n" +
	"\x04view\x18\x01 \x01(\x04R\x04view\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x04R\x03seq\x12\x16\n" +
	"\x06digest\x18\x03 \x01(\tR\x06digest\x12\x16\n" +
	"\x06assist\x18\x04 \x01(\bR\x06assist\"~\n" +
	"\x0eProposedRecord\x12:\n" +
	"\vpre_prepare\x18\x01 \x01(\v2\x19.binibftprotos.PrePrepareR\n" +
	"prePrepare\x120\n" +
	"\aprepare\x18\x02 \x01(\v2\x16.binibftprotos.PrepareR\aprepare\"\x96\x01\n" +
	"\x06Commit\x12\x12\n" +
	"\x04view\x18\x01 \x01(\x04R\x04view\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x04R\x03seq\x12\x16\n" +
	"\x06digest\x18\x03 \x01(\tR\x06digest\x126\n" +
	"\tsignature\x18\x04 \x01(\v2\x18.binibftprotos.SignatureR\tsignature\x12\x16\n" +
	...
	"\rlast_decision\x18\x02 \x01(\v2\x17.binibftprotos.ProposalR\flastDecision\x12R\n" +
	"\x18last_decision_signatures\x18\x03 \x03(\v2\x18.binibftprotos.SignatureR\x16lastDecisionSignatures\x12E\n" +
	"\x12in_flight_proposal\x18\x04 \x01(\v2\x17.binibftprotos.ProposalR\x10inFlightProposal\x12,\n" +
	...
	"\tsignature\x18\x03 \x01(\fR\tsignature\"R\n" +
	"\aNewView\x12G\n" +
	"\x10signed_view_data\x18\x02 \x03(\v2\x1d.binibftprotos.SignedViewDataR\x0esignedViewData\"1\n" +
	"\tHeartBeat\x12\x12\n" +
	"\x04view\x18\x01 \x01(\x04R\x04view\x12\x10\n" +
	...
	"\x1cprev_commit_signature_digest\x18\x05 \x01(\fR\x19prevCommitSignatureDigest\"\x8d\x02\n" +
	"\fSavedMessage\x12H\n" +
	"\x0fproposed_record\x18\x01 \x01(\v2\x1d.binibftprotos.ProposedRecordH\x00R\x0eproposedRecord\x120\n" +
	"\x06commit\x18\x02 \x01(\v2\x16.binibftprotos.MessageH\x00R\x06commit\x128\n" +
	"\bnew_view\x18\x03 \x01(\v2\x1b.binibftprotos.ViewMetadataH\x00R\anewView\x12<\n" +
	"\vview_change\x18\x04 \x01(\v2\x19.binibftprotos.ViewChangeH\x00R\n" +
	"viewChangeB\t\n" +
	"\acontent\"\x16\n" +
	...
	"\bsequence\x18\x02 \x01(\x04R\bsequenceB%Z#binibft-poc/consensus/binibftprotosb\x06proto3"
...
var file_messages_proto_goTypes = []any{
	(*Message)(nil),               // 0: binibftprotos.Message
	(*PrePrepare)(nil),            // 1: binibftprotos.PrePrepare
	(*Prepare)(nil),               // 2: binibftprotos.Prepare
	(*ProposedRecord)(nil),        // 3: binibftprotos.ProposedRecord
	(*Commit)(nil),                // 4: binibftprotos.Commit
	(*PreparesFrom)(nil),          // 5: binibftprotos.PreparesFrom
	(*ViewChange)(nil),            // 6: binibftprotos.ViewChange
	(*ViewData)(nil),              // 7: binibftprotos.ViewData
	(*SignedViewData)(nil),        // 8: binibftprotos.SignedViewData
	(*NewView)(nil),               // 9: binibftprotos.NewView
	(*HeartBeat)(nil),             // 10: binibftprotos.HeartBeat
	(*HeartBeatResponse)(nil),     // 11: binibftprotos.HeartBeatResponse
	(*Signature)(nil),             // 12: binibftprotos.Signature
	(*Proposal)(nil),              // 13: binibftprotos.Proposal
	(*ViewMetadata)(nil),          // 14: binibftprotos.ViewMetadata
	(*SavedMessage)(nil),          // 15: binibftprotos.SavedMessage
	(*StateTransferRequest)(nil),  // 16: binibftprotos.StateTransferRequest
	(*StateTransferResponse)(nil), // 17: binibftprotos.StateTransferResponse
}
var file_messages_proto_depIdxs = []int32{
	1,  // 0: binibftprotos.Message.pre_prepare:type_name -> binibftprotos.PrePrepare
	2,  // 1: binibftprotos.Message.prepare:type_name -> binibftprotos.Prepare
	4,  // 2: binibftprotos.Message.commit:type_name -> binibftprotos.Commit
	6,  // 3: binibftprotos.Message.view_change:type_name -> binibftprotos.ViewChange
	8,  // 4: binibftprotos.Message.view_data:type_name -> binibftprotos.SignedViewData
	9,  // 5: binibftprotos.Message.new_view:type_name -> binibftprotos.NewView
	10, // 6: binibftprotos.Message.heart_beat:type_name -> binibftprotos.HeartBeat
	11, // 7: binibftprotos.Message.heart_beat_response:type_name -> binibftprotos.HeartBeatResponse
	16, // 8: binibftprotos.Message.state_transfer_request:type_name -> binibftprotos.StateTransferRequest
	17, // 9: binibftprotos.Message.state_transfer_response:type_name -> binibftprotos.StateTransferResponse
	13, // 10: binibftprotos.PrePrepare.proposal:type_name -> binibftprotos.Proposal
	12, // 11: binibftprotos.PrePrepare.prev_commit_signatures:type_name -> binibftprotos.Signature
	1,  // 12: binibftprotos.ProposedRecord.pre_prepare:type_name -> binibftprotos.PrePrepare
	2,  // 13: binibftprotos.ProposedRecord.prepare:type_name -> binibftprotos.Prepare
	12, // 14: binibftprotos.Commit.signature:type_name -> binibftprotos.Signature
	13, // 15: binibftprotos.ViewData.last_decision:type_name -> binibftprotos.Proposal
	12, // 16: binibftprotos.ViewData.last_decision_signatures:type_name -> binibftprotos.Signature
	13, // 17: binibftprotos.ViewData.in_flight_proposal:type_name -> binibftprotos.Proposal
	8,  // 18: binibftprotos.NewView.signed_view_data:type_name -> binibftprotos.SignedViewData
	3,  // 19: binibftprotos.SavedMessage.proposed_record:type_name -> binibftprotos.ProposedRecord
	0,  // 20: binibftprotos.SavedMessage.commit:type_name -> binibftprotos.Message
	14, // 21: binibftprotos.SavedMessage.new_view:type_name -> binibftprotos.ViewMetadata
	6,  // 22: binibftprotos.SavedMessage.view_change:type_name -> binibftprotos.ViewChange
