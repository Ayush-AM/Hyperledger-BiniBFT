...
type LogRecord struct {
	...
	Type          LogRecord_Type         `protobuf:"varint,1,opt,name=type,proto3,enum=binibftprotos.LogRecord_Type" json:"type,omitempty"`
...
const file_logrecord_proto_rawDesc = "" +
	"\n" +
	"\x0flogrecord.proto\x12\rbinibftprotos\"\xa3\x01\n" +
	"\tLogRecord\x121\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1d.binibftprotos.LogRecord.TypeR\x04type\x12\x1f\n" +
	...
	"\n" +
	"CRC_ANCHOR\x10\x02B%Z#binibft-poc/consensus/binibftprotosb\x06proto3"
...
var file_logrecord_proto_goTypes = []any{
	(LogRecord_Type)(0), // 0: binibftprotos.LogRecord.Type
	(*LogRecord)(nil),   // 1: binibftprotos.LogRecord
}
var file_logrecord_proto_depIdxs = []int32{
	0, // 0: binibftprotos.LogRecord.type:type_name -> binibftprotos.LogRecord.Type
